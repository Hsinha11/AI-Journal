    ...
    if (error) return (
        <div className="mt-8 max-w-4xl mx-auto px-4">
            <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
                <div className="text-red-600 font-medium">Please log in to see your entries</div>
            </div>
        </div>
    );
    ...
    return (
        <div className="mt-8 max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center gap-3">
                <span className="bg-gradient-to-r from-purple-600 to-blue-500 text-transparent bg-clip-text">Your Journal</span>
                <span className="text-lg font-normal text-gray-400">✨ Reflect & Grow</span>
            </h2>
            <div className="space-y-6">
                {entries.length > 0 ? (
                    entries.map((entry) => (
                        <div key={entry._id} className="transform transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-800">No entries yet</h3>
                                <p className="text-gray-500 mt-1">Start writing your first journal entry above!</p>
                            </div>
                        </div>
                    </div>
                )}
